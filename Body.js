  ...
  return (
    <div>
        <div className="body">
            ...
            <div className="col-md-4">
              <div className="card">
                   <div className="image">
                    ...
                    <button className="btn" id='butt' ><a href="https://www.linkedin.com/in/devalla-soma-sekhar-reddy-8b97b5228/">Connect</a></button>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card">
          ...
          <h5>Please signin for More information</h5>
        </div>
    </div>
  )
}
